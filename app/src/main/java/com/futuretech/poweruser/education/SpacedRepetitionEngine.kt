...
object SpacedRepetitionEngine {
    ...
    /**
     * Hints never subtract points. They only change how soon independent retrieval
     * should be checked again. This uses local timestamps only and has zero API cost.
     */
