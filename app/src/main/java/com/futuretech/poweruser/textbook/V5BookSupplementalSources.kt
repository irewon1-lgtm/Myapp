...
object V5BookSupplementalSources {
    ...
    val sources: List<V5BookSource> = listOf(
        ...
        s("OCI-RUNTIME13", "OCI Runtime Specification", "Open Container Initiative", V5BookSource.SourceType.STANDARD, "v1.3.0, released 2025-11-04", "https://specs.opencontainers.org/runtime-spec/"),
        ...
        s("LINUX-SECCOMP", "Seccomp BPF (SECure COMPuting with filters)", "Linux kernel documentation", V5BookSource.SourceType.OFFICIAL_DOC, "current userspace API docs audited 2026-09", "https://docs.kernel.org/userspace-api/seccomp_filter.html"),
        s("LINUX-OVERLAYFS", "Overlay Filesystem", "Linux kernel documentation", V5BookSource.SourceType.OFFICIAL_DOC, "current filesystem docs audited 2026-09", "https://docs.kernel.org/filesystems/overlayfs.html"),
        ...
        s("LINUX-EDAC", "Error Detection And Correction (EDAC) Devices", "Linux kernel documentation", V5BookSource.SourceType.OFFICIAL_DOC, "latest documentation audited 2026-09", "https://docs.kernel.org/driver-api/edac.html"),
        ...
        s("LINUX-LOCKUP-WATCHDOG", "Softlockup detector and hardlockup detector (nmi_watchdog)", "Linux kernel documentation", V5BookSource.SourceType.OFFICIAL_DOC, "current documentation audited 2026-09", "https://docs.kernel.org/admin-guide/lockup-watchdogs.html"),
        s("LINUX-KDUMP", "Documentation for Kdump - the kexec-based crash dumping solution", "Linux kernel documentation", V5BookSource.SourceType.OFFICIAL_DOC, "current documentation audited 2026-09", "https://docs.kernel.org/admin-guide/kdump/kdump.html"),
        s("LINUX-RAMOOPS", "Ramoops oops/panic logger", "Linux kernel documentation", V5BookSource.SourceType.OFFICIAL_DOC, "current documentation audited 2026-09", "https://docs.kernel.org/admin-guide/ramoops.html"),
        s("LINUX-PSTORE", "Persistent crash/shutdown logging with pstore", "Linux kernel documentation", V5BookSource.SourceType.OFFICIAL_DOC, "current documentation audited 2026-09", "https://docs.kernel.org/power/shutdown-debugging.html"),
        s("LINUX-NFTABLES-NETLINK", "Family nftables netlink specification", "Linux kernel documentation", V5BookSource.SourceType.OFFICIAL_DOC, "current specification audited 2026-09", "https://docs.kernel.org/netlink/specs/nftables.html"),
        s("LINUX-CONNTRACK-NETLINK", "Family conntrack netlink specification", "Linux kernel documentation", V5BookSource.SourceType.OFFICIAL_DOC, "current specification audited 2026-09", "https://docs.kernel.org/netlink/specs/conntrack.html"),
        s("LINUX-CONNTRACK-SYSCTL", "Netfilter Conntrack sysctl variables", "Linux kernel documentation", V5BookSource.SourceType.OFFICIAL_DOC, "current documentation audited 2026-09", "https://docs.kernel.org/networking/nf_conntrack-sysctl.html"),
        s("LINUX-NF-FLOWTABLE", "Netfilter flowtable infrastructure", "Linux kernel documentation", V5BookSource.SourceType.OFFICIAL_DOC, "current documentation audited 2026-09", "https://docs.kernel.org/networking/nf_flowtable.html"),
        s("LINUX-NETLINK-HANDBOOK", "Netlink Handbook", "Linux kernel documentation", V5BookSource.SourceType.OFFICIAL_DOC, "current userspace API handbook audited 2026-09", "https://docs.kernel.org/userspace-api/netlink/index.html"),
        s("LINUX-NETLINK-SPECS", "Netlink protocol specifications", "Linux kernel documentation", V5BookSource.SourceType.OFFICIAL_DOC, "current YAML specification docs audited 2026-09", "https://docs.kernel.org/userspace-api/netlink/specs.html"),
        s("LINUX-RT-LINK", "Family rt-link netlink specification", "Linux kernel documentation", V5BookSource.SourceType.OFFICIAL_DOC, "current specification audited 2026-09", "https://docs.kernel.org/netlink/specs/rt-link.html"),
        s("LINUX-RT-ADDR", "Family rt-addr netlink specification", "Linux kernel documentation", V5BookSource.SourceType.OFFICIAL_DOC, "current specification audited 2026-09", "https://docs.kernel.org/netlink/specs/rt-addr.html"),
        s("LINUX-RT-NEIGH", "Family rt-neigh netlink specification", "Linux kernel documentation", V5BookSource.SourceType.OFFICIAL_DOC, "current specification audited 2026-09", "https://docs.kernel.org/netlink/specs/rt-neigh.html"),
        s("LINUX-RT-ROUTE", "Family rt-route netlink specification", "Linux kernel documentation", V5BookSource.SourceType.OFFICIAL_DOC, "current specification audited 2026-09", "https://docs.kernel.org/netlink/specs/rt-route.html"),
        s("LINUX-RT-RULE", "Family rt-rule netlink specification", "Linux kernel documentation", V5BookSource.SourceType.OFFICIAL_DOC, "current specification audited 2026-09", "https://docs.kernel.org/netlink/specs/rt-rule.html"),
