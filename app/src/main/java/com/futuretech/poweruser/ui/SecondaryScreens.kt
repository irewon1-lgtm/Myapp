...
fun SpacedRepetitionReviewScreen(
    ...
    Scaffold(
        topBar = {
            TopAppBar(
                title = { Text("간격 반복 복습", fontSize = 18.sp, fontWeight = FontWeight.Bold) },
        ...
        Column(
            ...
            Text(
                "완주한 레슨은 1일 → 3일 → 7일 → 14일 간격으로 다시 확인합니다.",
                fontSize = 14.sp,
                    ...
                    items(dueReviews, key = { it.conceptId }) { item ->
                        Card(
                            ...
                            Column(modifier = Modifier.padding(16.dp)) {
                                ...
                                Text("핵심 개념: ${item.definition}", fontSize = 13.sp)
                                Text(
                                    "학습 목표: ${item.analogy}",
                                    fontSize = 13.sp,
                                ...
                                Spacer(modifier = Modifier.height(8.dp))
                                Text(
                                    "현재 복습 단계: ${item.reviewIntervalDays}일 · 성공 ${item.reviewCount}회",
                                    fontSize = 11.sp,
                                    color = MaterialTheme.colorScheme.outline
                                )
