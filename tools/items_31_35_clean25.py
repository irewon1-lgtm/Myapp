...
reader_width_ordered = 'widthIn(max = 780.dp)\n                    .fillMaxWidth()' in adaptive_reader
...
checks = [
    ...
    ("C02 tablet reader width capped", reader_width_ordered and 'READER_MAX_WIDTH_DP = 780' in ui_policy),
